#!/bin/zsh
# osu!megamix full playable prototype setup

mkdir -p layers/full_playable

cat > layers/full_playable/main.py <<'PYTHON_EOF'
...
mkdir -p layers/cat
cat > layers/cat/main.py <<'HOOK_EOF'
from layers.full_playable.main import start_full_playable

print("Hooking full playable auto-map into cat/base...")
start_full_playable()
HOOK_EOF

echo "Full playable prototype ready!"
echo "Run: python3 layers/cat/main.py"
